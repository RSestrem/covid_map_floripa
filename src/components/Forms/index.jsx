...
import { FileInput, FileInputLegend, FormInputData, FormsHeader, FormsWrapper } from "./styles";
    ...
    return (
        <FormsWrapper className="input-group">
            ...
            <FileInput>
                ...
                <FileInputLegend>Selecione um arquivo CSV com dados do COVID</FileInputLegend>
            ...
            <FormInputData>
                ...
                <div className="col-auto">
                    ...
                    <div className="col-auto pt-2">
                        <label for="validationDefault11" className="form-label">Un. de Saúde</label>
                    ...
                    <div className="d-grid gap-2 d-md-flex pt-4 justify-content-md-end">
